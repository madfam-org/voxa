...
- [ ] `JANUA_AUTH_REQUIRED=true` after OIDC live — code + manifests shipped; **API pods not rolling to new digest yet** (Argo `Progressing`/`Degraded`; use `health/ready.authEnforced` to verify)
